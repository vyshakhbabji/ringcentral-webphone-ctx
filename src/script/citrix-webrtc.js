...
Object.defineProperty(exports,"__esModule",{value:!0});exports.HDXMS_VERSION="1.2.0.2";var VersionData=function(){return function(a,e,c,b){this.major=a;this.minor=e;this.revision=c;this.build=b}}();exports.VersionData=VersionData;var FeatureData=function(){return function(){}}();exports.FeatureData=FeatureData;
var WebrpcFeatureInfo=function(){return function(a,e){this.fature=a;this.version=e}}(),FEATURE_ms_teams_redirection="ms_teams_redirection",FEATURE_ms_teams_desktop_sharing="ms_teams_desktop_sharing",FEATURE_ms_teams_speaking_indicator="ms_teams_speaking_indicator",feature_map=[new WebrpcFeatureInfo(FEATURE_ms_teams_redirection,new VersionData(1,1,0,0)),new WebrpcFeatureInfo(FEATURE_ms_teams_desktop_sharing,new VersionData(1,2,0,0)),new WebrpcFeatureInfo(FEATURE_ms_teams_speaking_indicator,new VersionData(1,
2,0,0))],class_id_t;
(function(a){a[a.EngineControl=0]="EngineControl";a[a.RTCPeerConnection=1]="RTCPeerConnection";a[a.RTCSessionDescription=2]="RTCSessionDescription";a[a.RTCIceCandidate=3]="RTCIceCandidate";a[a.RTCIceCandidateEvent=4]="RTCIceCandidateEvent";a[a.MediaDevices=5]="MediaDevices";a[a.MediaDeviceInfo=6]="MediaDeviceInfo";a[a.MediaStreamTrack=7]="MediaStreamTrack";a[a.MediaStreamEvent=8]="MediaStreamEvent";a[a.MediaStream=9]="MediaStream";a[a.NavigatorUserMedia=10]="NavigatorUserMedia";a[a.VideoElement=11]=
"VideoElement";a[a.AudioElement=12]="AudioElement";a[a.RTCRtpReceiver=13]="RTCRtpReceiver"})(class_id_t=exports.class_id_t||(exports.class_id_t={}));var method_id_EngineControl_t;(function(a){a[a.ctor=0]="ctor";a[a.version=1]="version";a[a.feature_flags=2]="feature_flags";a[a.version_info=3]="version_info"})(method_id_EngineControl_t=exports.method_id_EngineControl_t||(exports.method_id_EngineControl_t={}));var method_id_RTCPeerConnection_t;
...
a[a.onremovestream=25]="onremovestream";a[a.getStats=26]="getStats";a[a.getReceivers=27]="getReceivers"})(method_id_RTCPeerConnection_t=exports.method_id_RTCPeerConnection_t||(exports.method_id_RTCPeerConnection_t={}));var method_id_MediaDevices_t;(function(a){a[a.ctor=0]="ctor";a[a.enumerateDevices=1]="enumerateDevices";a[a.getDisplayMedia=2]="getDisplayMedia";a[a.ondevicechange=3]="ondevicechange"})(method_id_MediaDevices_t=exports.method_id_MediaDevices_t||(exports.method_id_MediaDevices_t={}));
var method_id_MediaDeviceInfo_t;(function(a){a[a.ctor=0]="ctor";a[a.deviceId=1]="deviceId";a[a.kind=2]="kind";a[a.label=3]="label";a[a.groupId=4]="groupId"})(method_id_MediaDeviceInfo_t=exports.method_id_MediaDeviceInfo_t||(exports.method_id_MediaDeviceInfo_t={}));var method_id_RTCSessionDescription_t;(function(a){a[a.ctor=0]="ctor";a[a.type=1]="type";a[a.sdp=2]="sdp"})(method_id_RTCSessionDescription_t=exports.method_id_RTCSessionDescription_t||(exports.method_id_RTCSessionDescription_t={}));var method_id_MediaStreamTrack_t;
(function(a){a[a.ctor=0]="ctor";a[a.kind=1]="kind";a[a.id=2]="id";a[a.label=3]="label";a[a.enabled=4]="enabled";a[a.muted=5]="muted";a[a.readyState=6]="readyState";a[a.onended=7]="onended";a[a.onmute=8]="onmute";a[a.onunmute=9]="onunmute";a[a.clone=10]="clone";a[a.stop=11]="stop";a[a.getCapabilities=12]="getCapabilities";a[a.getSettings=13]="getSettings";a[a.applyConstraints=14]="applyConstraints"})(method_id_MediaStreamTrack_t=exports.method_id_MediaStreamTrack_t||(exports.method_id_MediaStreamTrack_t=
{}));var method_id_MediaStream_t;(function(a){a[a.ctor=0]="ctor";a[a.id=1]="id";a[a.getAudioTracks=2]="getAudioTracks";a[a.getVideoTracks=3]="getVideoTracks";a[a.getTracks=4]="getTracks";a[a.getTrackById=5]="getTrackById";a[a.addTrack=6]="addTrack";a[a.removeTrack=7]="removeTrack";a[a.clone=8]="clone";a[a.active=9]="active"})(method_id_MediaStream_t=exports.method_id_MediaStream_t||(exports.method_id_MediaStream_t={}));var method_id_NavigatorUserMedia_t;
(function(a){a[a.ctor=0]="ctor";a[a.getUserMedia=1]="getUserMedia"})(method_id_NavigatorUserMedia_t=exports.method_id_NavigatorUserMedia_t||(exports.method_id_NavigatorUserMedia_t={}));var method_id_RTCIceCandidate_t;(function(a){a[a.ctor=0]="ctor";a[a.candidate=1]="candidate";a[a.sdpMid=2]="sdpMid";a[a.sdpMLineIndex=3]="sdpMLineIndex"})(method_id_RTCIceCandidate_t=exports.method_id_RTCIceCandidate_t||(exports.method_id_RTCIceCandidate_t={}));var method_id_RTCIceCandidateEvent_t;
(function(a){a[a.ctor=0]="ctor";a[a.candidate=1]="candidate"})(method_id_RTCIceCandidateEvent_t=exports.method_id_RTCIceCandidateEvent_t||(exports.method_id_RTCIceCandidateEvent_t={}));var method_id_MediaStreamEvent_t;(function(a){a[a.ctor=0]="ctor";a[a.stream=1]="stream"})(method_id_MediaStreamEvent_t=exports.method_id_MediaStreamEvent_t||(exports.method_id_MediaStreamEvent_t={}));var method_id_VideoElement_t;
(function(a){a[a.ctor=0]="ctor";a[a.sinkId=1]="sinkId";a[a.connectTo=2]="connectTo";a[a.disconnect=3]="disconnect";a[a.setFrame=4]="setFrame";a[a.addClipRect=5]="addClipRect";a[a.removeClipRect=6]="removeClipRect";a[a.onerror=7]="onerror";a[a.onvideoframechanged=8]="onvideoframechanged"})(method_id_VideoElement_t=exports.method_id_VideoElement_t||(exports.method_id_VideoElement_t={}));var method_id_AudioElement_t;
(function(a){a[a.ctor=0]="ctor";a[a.sinkId=1]="sinkId";a[a.srcObject=2]="srcObject";a[a.src=3]="src";a[a.play=4]="play";a[a.pause=5]="pause"})(method_id_AudioElement_t=exports.method_id_AudioElement_t||(exports.method_id_AudioElement_t={}));var method_id_RTCRtpReceiver_t;(function(a){a[a.ctor=0]="ctor";a[a.track=1]="track";a[a.getContributingSources=2]="getContributingSources"})(method_id_RTCRtpReceiver_t=exports.method_id_RTCRtpReceiver_t||(exports.method_id_RTCRtpReceiver_t={}));
var WebrpcMethodInfo=function(){return function(a,e,c,b,d){void 0===d&&(d=FEATURE_ms_teams_redirection);this.iid=a;this.mid=e;this.name=c;this.isprop=b;this.feature=d}}();exports.WebrpcMethodInfo=WebrpcMethodInfo;var WebrpcClassInfo=function(){return function(a,e,c){this.id=a;this.name=e;this.methods=c}}();exports.WebrpcClassInfo=WebrpcClassInfo;
var WebrpcClassLibInfo=function(){return function(a,e){this.name=a;this.classes=e}}(),class_lib_info=new WebrpcClassLibInfo("msteams_class_library",[new WebrpcClassInfo(class_id_t.EngineControl,"EngineControl",[new WebrpcMethodInfo(class_id_t.EngineControl,method_id_EngineControl_t.ctor,"ctor",!1),new WebrpcMethodInfo(class_id_t.EngineControl,method_id_EngineControl_t.version,"version",!0),new WebrpcMethodInfo(class_id_t.EngineControl,method_id_EngineControl_t.feature_flags,"feature_flags",!0),new WebrpcMethodInfo(class_id_t.EngineControl,
...
"RTCRtpReceiver",[new WebrpcMethodInfo(class_id_t.RTCRtpReceiver,method_id_RTCRtpReceiver_t.ctor,"ctor",!1,FEATURE_ms_teams_speaking_indicator),new WebrpcMethodInfo(class_id_t.RTCRtpReceiver,method_id_RTCRtpReceiver_t.track,"track",!0,FEATURE_ms_teams_speaking_indicator),new WebrpcMethodInfo(class_id_t.RTCRtpReceiver,method_id_RTCRtpReceiver_t.getContributingSources,"getContributingSources",!1,FEATURE_ms_teams_speaking_indicator)])]),WebrpcClassLibInfoUtil=function(){function a(){}a.getInterfaceByid=
function(a){for(var c=0,b=class_lib_info.classes;c<b.length;c++){var d=b[c];if(d.id==a)return d}return null};a.getMethodByid=function(a,c){var b=this.getInterfaceByid(a);if(null!=b)for(var d=0,b=b.methods;d<b.length;d++){var f=b[d];if(f.mid==c)return f}return null};a.getMethodFeatureByid=function(a,c){var b=this.getInterfaceByid(a);if(null!=b)for(var d=0,b=b.methods;d<b.length;d++){var f=b[d];if(f.mid==c)return f.feature}return null};a.composeClassInfoData=function(a){a=a.hdr;if(void 0==a)return"*** Invalid packet: Couldn't find hdr object ***";
var c=a.proc;if(void 0==c)return"";a=c.iid;for(var c=c.methodid,b=0,d=class_lib_info.classes;b<d.length;b++){var f=d[b];if(f.id==a)for(var g=0,h=f.methods;g<h.length;g++){var k=h[g];if(k.mid==c)return f.name+"::"+k.name}}return""};return a}();exports.WebrpcClassLibInfoUtil=WebrpcClassLibInfoUtil;
...
var __extends=this&&this.__extends||function(){var a=function(b,c){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,c){a.__proto__=c}||function(a,c){for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b])};return a(b,c)};return function(b,c){function e(){this.constructor=b}a(b,c);b.prototype=null===c?Object.create(c):(e.prototype=c.prototype,new e)}}(),__awaiter=this&&this.__awaiter||function(a,b,c,e){return new (c||(c=Promise))(function(d,f){function h(a){try{k(e.next(a))}catch(c){f(c)}}
function g(a){try{k(e["throw"](a))}catch(c){f(c)}}function k(a){a.done?d(a.value):(new c(function(c){c(a.value)})).then(h,g)}k((e=e.apply(a,b||[])).next())})},__generator=this&&this.__generator||function(a,b){function c(a){return function(c){return e([a,c])}}function e(c){if(f)throw new TypeError("Generator is already executing.");for(;d;)try{if(f=1,h&&(g=c[0]&2?h["return"]:c[0]?h["throw"]||((g=h["return"])&&g.call(h),0):h.next)&&!(g=g.call(h,c[1])).done)return g;if(h=0,g)c=[c[0]&2,g.value];switch(c[0]){case 0:case 1:g=
c;break;case 4:return d.label++,{value:c[1],done:!1};case 5:d.label++;h=c[1];c=[0];continue;case 7:c=d.ops.pop();d.trys.pop();continue;default:if(!(g=d.trys,g=0<g.length&&g[g.length-1])&&(6===c[0]||2===c[0])){d=0;continue}if(3===c[0]&&(!g||c[1]>g[0]&&c[1]<g[3]))d.label=c[1];else if(6===c[0]&&d.label<g[1])d.label=g[1],g=c;else if(g&&d.label<g[2])d.label=g[2],d.ops.push(c);else{g[2]&&d.ops.pop();d.trys.pop();continue}}c=b.call(a,d)}catch(e){c=[6,e],h=0}finally{f=g=0}if(c[0]&5)throw c[1];return{value:c[0]?
c[1]:void 0,done:!0}}var d={label:0,sent:function(){if(g[0]&1)throw g[1];return g[1]},trys:[],ops:[]},f,h,g,k;$jscomp.initSymbol();$jscomp.initSymbol();$jscomp.initSymbolIterator();return k={next:c(0),"throw":c(1),"return":c(2)},"function"===typeof Symbol&&(k[Symbol.iterator]=function(){return this}),k};Object.defineProperty(exports,"__esModule",{value:!0});
var webrpcclassinfo_1=__webpack_require__(1),proxyobject_1=__webpack_require__(2),logger_1=__webpack_require__(0),SimpleEvent=function(){return function(a, b){this.type=a;this.target=b}}(),CloneState=function(){function a(){this.is_local_clone=!1;this.clone_id=this.clone_count=0}a.prototype.clone=function(){this.clone_count++;var b=new a;b.is_local_clone=!0;b.clone_id=this.clone_count;return b};a.prototype.synchronize=function(a){return __awaiter(this,void 0,void 0,function(){return __generator(this,
function(c){return this.is_local_clone?[2,a.asyncClone()]:[2,a]})})};return a}(),RemoteMediaTrack=function(a){function b(c,b){var d=a.call(this,c,webrpcclassinfo_1.class_id_t.MediaStreamTrack,b,!0)||this;d.refCount_=0;d.refCount_++;d.clone_state=new CloneState;return d}__extends(b,a);Object.defineProperty(b.prototype,"refcount",{get:function(){return this.refCount_},enumerable:!0,configurable:!0});b.prototype.addRef=function(){this.refCount_++;logger_1.logger.log(this.user_friendly_id()+".addRef() called. [id="+
this.id+"] refcount="+this.refCount_)};Object.defineProperty(b.prototype,"onended",{get:function(){logger_1.logger.log(this.user_friendly_id()+".get_onended() called. [id="+this.id+"]");return this.onended_},set:function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".set_onended() called. [id="+this.id+"]");this.onended_=a;this.waitUntilConnected("MediaStreamTrack.onended").then(function(){var d=b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_MediaStreamTrack_t.onended);
d.then(function(a){logger_1.logger.log(b.user_friendly_id()+"onended event received!!!");a=new SimpleEvent("ended",b);b.readyState_="ended";b.onended_(a)});return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_MediaStreamTrack_t.onended,d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".onended failed!!!")})},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"onmute",{get:function(){logger_1.logger.log(this.user_friendly_id()+".get_onmute() called. [id="+this.id+
"]");return this.onmute_},set:function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".set_onmute() called. [id="+this.id+"]");this.onmute_=a;this.waitUntilConnected("MediaStreamTrack.onmute").then(function(){var d=b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_MediaStreamTrack_t.onmute);d.then(function(a){logger_1.logger.log(b.user_friendly_id()+"onmute event received!!!");a=new SimpleEvent("mute",b);b.muted=!0;b.onmute_(a)});return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_MediaStreamTrack_t.onmute,
d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".onmute failed!!!")})},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"onunmute",{get:function(){logger_1.logger.log(this.user_friendly_id()+".get_onunmute() called. [id="+this.id+"]");return this.onunmute_},set:function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".set_onunmute() called. [id="+this.id+"]");this.onunmute_=a;this.waitUntilConnected("MediaStreamTrack.onunmute").then(function(){var d=
b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_MediaStreamTrack_t.onunmute);d.then(function(a){logger_1.logger.log("onunmute event received!!!");a=new SimpleEvent("unmute",b);b.muted=!1;b.onunmute_(a)});return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_MediaStreamTrack_t.onunmute,d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".onunmute failed!!!")})},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"onstop",{set:function(a){this.onstop_=
a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"enabled",{get:function(){logger_1.logger.log(this.user_friendly_id()+".get_enabled() called. [id="+this.id+", value="+this.enabled_+"]");return this.enabled_},set:function(a){logger_1.logger.log(this.user_friendly_id()+".set_enabled() called. [id="+this.id+", value="+a+"]");this.enabled_=a;this.remoteInvoke(!0,webrpcclassinfo_1.method_id_MediaStreamTrack_t.enabled,a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,
"readyState",{get:function(){logger_1.logger.log(this.user_friendly_id()+".get_readyState() called. [id="+this.id+"]");return this.readyState_},enumerable:!0,configurable:!0});b.prototype.asyncClone=function(){return __awaiter(this,void 0,void 0,function(){var a,e,d;return __generator(this,function(f){switch(f.label){case 0:return[4,this.waitUntilConnected("RemoteMediaTrack.asyncClone")];case 1:return f.sent(),[4,this.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamTrack_t.clone,[])];case 2:return a=
f.sent(),e=this.param0(a),d=new b(this,e.oid),[2,d.syncBarrier()]}})})};b.prototype.clone=function(){logger_1.logger.log(this.user_friendly_id()+".clone() called. [id="+this.id+"]");var a=this.clone_state.clone(),e=new b(this,this.object_id());e.id=this.id+"."+a.clone_id.toString();e.label=this.label;e.kind=this.kind;e.enabled_=this.enabled_;e.muted=this.muted;e.readyState_=this.readyState_;e.trackSettings_=this.trackSettings_;e.clone_state=a;return e};b.prototype.stop=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+
".stop() called. [id="+this.id+"] refcount="+this.refCount_);this.readyState_="ended";if(0<this.refCount_&&(this.refCount_--,0===this.refCount_&&(logger_1.logger.log(this.user_friendly_id()+".stop() called. [id="+this.id+"] remote invoking..."),this.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamTrack_t.stop)["catch"](function(b){logger_1.logger.log(a.user_friendly_id()+".stop() failed with:"+b)}),null!==this.onstop_)))this.onstop_()};b.prototype.getCapabilities=function(){logger_1.logger.log(this.user_friendly_id()+
".getCapabilities() called. [id="+this.id+"]")};b.prototype.getConstrains=function(){logger_1.logger.log(this.user_friendly_id()+".getConstrains() called. [id="+this.id+"]")};b.prototype.getSettings=function(){return"audio"==this.kind?function(a){return{deviceId:a.deviceId,echoCancellation:a.echoCancellation}}(this.trackSettings_):function(a){return{aspectRatio:a.aspectRatio,deviceId:a.deviceId,frameRate:a.frameRate,height:a.height,width:a.width}}(this.trackSettings_)};b.prototype.applyConstraints=
function(a){var b=this;logger_1.logger.log("MediaStreamTrack.applyConstraints() called.");return new Promise(function(d,f){b.waitUntilConnected("MediaStreamTrack.applyConstraints").then(function(){return b.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamTrack_t.applyConstraints,a)}).then(function(){d()})["catch"](function(){f({name:"OverconstrainedError",message:"Failed to apply constraints."})})})};b.convertReadyState=function(a){return 0==a?"live":"ended"};b.prototype.syncBarrier=function(){var a=
this;logger_1.logger.log(this.user_friendly_id()+".syncBarrier() called.");return new Promise(function(e,d){a.waitUntilConnected("MediaStreamTrack.syncBarrier").then(function(){return Promise.all([a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamTrack_t.kind,""),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamTrack_t.id,""),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamTrack_t.label,""),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamTrack_t.enabled,!1),a.remoteInvoke(!1,
webrpcclassinfo_1.method_id_MediaStreamTrack_t.muted,!1),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamTrack_t.readyState,0),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamTrack_t.getSettings)])}).then(function(d){var h=0;d=d.map(function(b){return a.param0(b)});a.kind=d[0];a.id=d[1];a.label=d[2];a.enabled_=d[3];a.muted=d[4];h=d[5];a.trackSettings_=d[6];a.readyState_=b.convertReadyState(h);e(a)})["catch"](function(){d()})})};return b}(proxyobject_1.ProxyObject);
exports.RemoteMediaTrack=RemoteMediaTrack;
var StreamInfo=function(){return function(){}}(),RemoteStream=function(a){function b(c,b){var d=a.call(this,c,webrpcclassinfo_1.class_id_t.MediaStream,b,!0)||this;d.clone_state=new CloneState;return d}__extends(b,a);b.prototype.dumpTrackInfo=function(){logger_1.logger.log(this.user_friendly_id()+".dumpTrackInfo() called. [id="+this.id+"]");for(var a=0,b=this.tracks_;a<b.length;a++){var d=b[a];logger_1.logger.log(d.user_friendly_id()+" [id="+d.id+"] refcount="+d.refcount)}};b.prototype.toJSON=function(){var a=
new StreamInfo;a.id=this.id;a.active=this.active;a.oid=this.object_id();return"RemoteStream:"+JSON.stringify(a)};b.prototype.getAudioTracks=function(){logger_1.logger.log(this.user_friendly_id()+".getAudioTracks() called. [id="+this.id+"]");for(var a=[],b=0,d=this.tracks_;b<d.length;b++){var f=d[b];"audio"==f.kind&&a.push(f)}return a};b.prototype.getVideoTracks=function(){logger_1.logger.log(this.user_friendly_id()+".getVideoTracks() called. [id="+this.id+"]");for(var a=[],b=0,d=this.tracks_;b<d.length;b++){var f=
d[b];"video"==f.kind&&a.push(f)}return a};b.prototype.getTracks=function(){logger_1.logger.log(this.user_friendly_id()+".getTracks() called. [id="+this.id+"]");return this.tracks_};b.prototype.getTrackById=function(a){logger_1.logger.log(this.user_friendly_id()+".getTrackById() called. [id="+this.id+"]");for(var b=0,d=this.tracks_;b<d.length;b++){var f=d[b];if(f.id==a)return f}};b.prototype.addTrack=function(a){logger_1.logger.log(this.user_friendly_id()+".addTrack() called. [id="+this.id+"]");this.tracks_.push(a);
this.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStream_t.addTrack,{oid:a.object_id()})};b.prototype.removeTrack=function(a){logger_1.logger.log(this.user_friendly_id()+".removeTrack() called. [id="+this.id+"]");var b=this.tracks_.indexOf(a);this.tracks_.splice(b,1);this.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStream_t.removeTrack,{oid:a.object_id()})};b.prototype.asyncClone=function(){return __awaiter(this,void 0,void 0,function(){var a,e,d;return __generator(this,function(f){switch(f.label){case 0:return logger_1.logger.log(this.user_friendly_id()+
".asyncClone() called. [id="+this.id+"]"),[4,this.waitUntilConnected("asyncClone")];case 1:return f.sent(),[4,this.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStream_t.clone,[])];case 2:return a=f.sent(),console.log(a),e=this.param0(a),d=new b(this,e.oid),[2,d.syncBarrier()]}})})};b.prototype.clone=function(){logger_1.logger.log(this.user_friendly_id()+".clone() called. [id="+this.id+"]");var a=this.clone_state.clone(),e=new b(this,this.object_id());e.id=this.id+"."+a.clone_id.toString();this.tracks_.forEach(function(a){a.addRef()});
e.tracks_=this.tracks_;e.clone_state=a;return e};b.prototype.syncBarrier=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".syncBarrier() called. [id="+this.id+"]");return new Promise(function(b,d){a.waitUntilConnected("MediaStream.syncBarrier").then(function(){return Promise.all([a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStream_t.id,""),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStream_t.active,!1),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStream_t.getTracks,
[])])}).then(function(b){b=b.map(function(b){return a.param0(b)});a.id=b[0];a.active=b[1];b=b[2];for(var e=[],d=0;d<b.length;d++){var k=new RemoteMediaTrack(a,b[d].oid);e.push(k.syncBarrier())}return Promise.all(e)}).then(function(d){a.tracks_=[];d.forEach(function(b){b.onstop=function(){var b=!0;a.tracks_.forEach(function(a){"ended"!=a.readyState&&(b=!1)});b&&a.release()};a.tracks_.push(b)});b(a)})["catch"](function(){d()})})};return b}(proxyobject_1.ProxyObject);exports.RemoteStream=RemoteStream;
var RemoteStreamEvent=function(a){function b(b,e){return a.call(this,b,webrpcclassinfo_1.class_id_t.MediaStreamEvent,e,!0)||this}__extends(b,a);b.prototype.syncBarrier=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".syncBarrier() called.");return new Promise(function(b,d){a.waitUntilConnected("MediaStreamEvent.syncBarrier").then(function(){return a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaStreamEvent_t.stream,{oid:0})}).then(function(b){return(new RemoteStream(a,b.params[0].oid)).syncBarrier()}).then(function(d){a.stream=
d;b(a)})["catch"](function(){d()})})};return b}(proxyobject_1.ProxyObject);exports.RemoteStreamEvent=RemoteStreamEvent;
var RemoteDeviceInfo=function(a){function b(b){return a.call(this,null,webrpcclassinfo_1.class_id_t.MediaDeviceInfo,b,!0)||this}__extends(b,a);b.prototype.convertKind=function(a){return 0==a?"audioinput":1==a?"audiooutput":"videoinput"};b.prototype.syncBarrier=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".syncBarrier() called.");return new Promise(function(b,d){a.waitUntilConnected("RemoteDeviceInfo.syncBarrier").then(function(){return Promise.all([a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaDeviceInfo_t.deviceId,
""),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaDeviceInfo_t.kind,0),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaDeviceInfo_t.label,""),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaDeviceInfo_t.groupId,"")])}).then(function(d){a.kind=a.convertKind(a.param0(d.splice(1,1)[0]));d=d.map(function(b){return a.param0(b)});a.deviceId=d[0];a.label=d[1];a.groupId=d[2];b(a)})["catch"](function(){logger_1.logger.log(a.user_friendly_id()+".syncBarrier(): rejected.");d()})})};return b}(proxyobject_1.ProxyObject);
exports.RemoteDeviceInfo=RemoteDeviceInfo;
var RemoteDevices=function(a){function b(){var b=a.call(this,null,webrpcclassinfo_1.class_id_t.MediaDevices,0,!1)||this;b.devices_=[];b.setDeviceChangeCallback();return b}__extends(b,a);b.prototype.enumerateDevices=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".enumerateDevices() called");return new Promise(function(b,d){a.waitUntilConnected("RemoteDevices.enumerateDevices").then(function(){return a.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaDevices_t.enumerateDevices,[])}).then(function(b){var d=
[];b.params[0].forEach(function(b){var e=a.devices_.find(function(a){return a.object_id()===b.oid});void 0===e?(e=new RemoteDeviceInfo(b.oid),d.push(e.syncBarrier())):d.push(e)});return Promise.all(d)}).then(function(d){logger_1.logger.log(a.user_friendly_id()+".enumerateDevices: returning enumerated devices with ids ["+d.map(function(a){return a.object_id()})+"]");b(d);a.devices_.forEach(function(a){for(var b=!0,c=0;c<d.length;c++)if(a===d[c]){b=!1;break}b&&a.release()});a.devices_=d})["catch"](function(){logger_1.logger.log(a.user_friendly_id()+
".enumerateDevices() didnt get response.");a.devices_=[];d()})})};b.prototype.getDisplayMedia=function(a){var b=this;return new Promise(function(d,f){b.waitUntilConnected("RemoteDevices.getDisplayMedia").then(function(){return b.remoteInvoke(!1,webrpcclassinfo_1.method_id_MediaDevices_t.getDisplayMedia,a)}).then(function(a){return(new RemoteStream(null,a.params[0].oid)).syncBarrier()}).then(function(a){d(a)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".getDisplayMedia() returned an error.");
f(new DOMException("Unable to get a display stream.","NotReadableError"))})})};b.prototype.setDeviceChangeCallback=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".set_DeviceChangeCallback() called.");this.waitUntilConnected("MediaDevices.ondevicechange").then(function(){var b=a.registerCallbacks(!1,!1,webrpcclassinfo_1.method_id_MediaDevices_t.ondevicechange);b.then(function(){logger_1.logger.log(a.user_friendly_id()+".ondevicechange(): callback received!!!");navigator.mediaDevices.dispatchEvent(new CustomEvent("devicechange"))});
return a.remoteInvoke(!0,webrpcclassinfo_1.method_id_MediaDevices_t.ondevicechange,b.success)})["catch"](function(){logger_1.logger.log(a.user_friendly_id()+".set_ondevicechange(): failed.")})};return b}(proxyobject_1.ProxyObject);exports.RemoteDevices=RemoteDevices;
var NavigatorUserMedia=function(a){function b(){return a.call(this,null,webrpcclassinfo_1.class_id_t.NavigatorUserMedia,0,!1)||this}__extends(b,a);b.prototype.webkitGetUserMedia=function(a,b,d){this.getUserMedia(a,b,d)};b.prototype.getUserMedia=function(a,b,d){var f=this;logger_1.logger.log(this.user_friendly_id()+".getUserMedia() called: "+JSON.stringify(a));this.waitUntilConnected("NavigatorUserMedia.getUserMedia").then(function(){var b=f.registerCallbacks(!0,!1,webrpcclassinfo_1.method_id_NavigatorUserMedia_t.getUserMedia);
...
a,b.success,b.fail);return b.prom()}).then(function(a){logger_1.logger.log(f.user_friendly_id()+".getUserMedia: received success callback!");return(new RemoteStream(null,f.param0(a).oid)).syncBarrier()}).then(function(a){logger_1.logger.log(f.user_friendly_id()+".getUserMedia: MediaStream ready to deliver",JSON.stringify(a));0==a.getTracks().length?(logger_1.logger.log(f.user_friendly_id()+".getUserMedia: reporting no tracks as error."),d({constraintName:"",name:"ConstraintNotSatisfiedError",message:""})):
b(a)})["catch"](function(a){logger_1.logger.log(a);d({constraintName:"",name:"ConstraintNotSatisfiedError",message:""})})};return b}(proxyobject_1.ProxyObject);exports.NavigatorUserMedia=NavigatorUserMedia;
...
c;break;case 4:return d.label++,{value:c[1],done:!1};case 5:d.label++;h=c[1];c=[0];continue;case 7:c=d.ops.pop();d.trys.pop();continue;default:if(!(g=d.trys,g=0<g.length&&g[g.length-1])&&(6===c[0]||2===c[0])){d=0;continue}if(3===c[0]&&(!g||c[1]>g[0]&&c[1]<g[3]))d.label=c[1];else if(6===c[0]&&d.label<g[1])d.label=g[1],g=c;else if(g&&d.label<g[2])d.label=g[2],d.ops.push(c);else{g[2]&&d.ops.pop();d.trys.pop();continue}}c=b.call(a,d)}catch(e){c=[6,e],h=0}finally{f=g=0}if(c[0]&5)throw c[1];return{value:c[0]?
c[1]:void 0,done:!0}}var d={label:0,sent:function(){if(g[0]&1)throw g[1];return g[1]},trys:[],ops:[]},f,h,g,k;$jscomp.initSymbol();$jscomp.initSymbol();$jscomp.initSymbolIterator();return k={next:c(0),"throw":c(1),"return":c(2)},"function"===typeof Symbol&&(k[Symbol.iterator]=function(){return this}),k};Object.defineProperty(exports,"__esModule",{value:!0});
var remotemedia_1=__webpack_require__(5),proxyobject_1=__webpack_require__(2),webrpcclassinfo_1=__webpack_require__(1),logger_1=__webpack_require__(0),stats_1=__webpack_require__(10);function ensure_config_defined(a){return void 0!=a?a:{}}
var IceCandidateEvent=function(a){function b(c,b,d){c=a.call(this,c,webrpcclassinfo_1.class_id_t.RTCIceCandidateEvent,b,!0)||this;c.target=d;c.type="icecandidate";return c}__extends(b,a);Object.defineProperty(b.prototype,"candidate",{get:function(){return this.candidate_},enumerable:!0,configurable:!0});b.prototype.syncBarrier=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".syncBarrier() called.");return new Promise(function(b,d){a.waitUntilConnected("IceCandidateEvent.syncBarrier").then(function(){return a.remoteInvoke(!1,
webrpcclassinfo_1.method_id_RTCIceCandidateEvent_t.candidate,{oid:0})}).then(function(b){b=a.param0(b);return!1===b.is_null?(new IceCandidate(a,b.oid)).syncBarrier():Promise.resolve(null)}).then(function(d){logger_1.logger.log(a.user_friendly_id()+".onicecandidate: icecandidate available!");a.candidate_=d;b(a)})["catch"](function(){logger_1.logger.log(a.user_friendly_id()+".onicecandidate() failed.");d()})})};return b}(proxyobject_1.ProxyObject);exports.IceCandidateEvent=IceCandidateEvent;
var IceCandidate=function(a){function b(c,b){return a.call(this,c,webrpcclassinfo_1.class_id_t.RTCIceCandidate,b,!0)||this}__extends(b,a);Object.defineProperty(b.prototype,"candidate",{get:function(){return this.candidate_},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"sdpMid",{get:function(){return this.sdpMid_},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"sdpMLineIndex",{get:function(){return this.sdpMLineIndex_},enumerable:!0,configurable:!0});b.prototype.syncBarrier=
function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".syncBarrier() called.");return new Promise(function(b,d){a.waitUntilConnected("IceCandidate.syncBarrier").then(function(){return Promise.all([a.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCIceCandidate_t.candidate,""),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCIceCandidate_t.sdpMid,""),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCIceCandidate_t.sdpMLineIndex,0)])}).then(function(d){d=d.map(function(b){return a.param0(b)});
a.candidate_=d[0];a.sdpMid_=d[1];a.sdpMLineIndex_=d[2];b(a)})["catch"](function(){d()})})};return b}(proxyobject_1.ProxyObject);exports.IceCandidate=IceCandidate;
var IceGatherer=function(){function a(a){this.state_="new";this.candidates_=[];this.pc_=a}a.prototype.pushState=function(a){logger_1.logger.log(this.pc_.user_friendly_id()+".onicegatheringstatechange: new state is "+a);this.state_=a;"gathering"==this.state_?(this.candidates_=[],this.postUpdate()):this.processRemaining()};a.prototype.addIceCandidate=function(a){var c=this;this.candidates_.push(a);a.syncBarrier().then(function(a){logger_1.logger.log(c.pc_.user_friendly_id()+".onicecandidate: icecandidate available!");
return Promise.all([c.pc_.updateLocalDescription(),Promise.resolve(a)])}).then(function(a){c.postIceCandidate(a[1])})};a.prototype.postIceCandidate=function(a){logger_1.logger.log(this.pc_.user_friendly_id()+".onicecandidate: posting ice candidate now!");if(null!=this.pc_.onicecandidate)this.pc_.onicecandidate(a);else logger_1.logger.log(this.pc_.user_friendly_id()+"onicecandidate is NULL!!!");this.candidates_.shift();this.processRemaining()};a.prototype.postUpdate=function(){logger_1.logger.log(this.pc_.user_friendly_id()+
".onicegatheringstatechange: posting event now!");var a=new PeerConnectionEvent("onicegatheringstatechange",this.pc_);this.pc_.onicegatheringstatechange(a)};a.prototype.processRemaining=function(){0==this.candidates_.length&&"complete"==this.state_?(this.pc_.onicecandidate({candidate:null,target:this}),this.postUpdate()):logger_1.logger.log(this.pc_.user_friendly_id()+".onicecandidate: candidates remaining=["+this.candidates_.map(function(a){return a.object_id()})+"], state="+this.state_)};return a}(),
SessionDescription=function(a){function b(c,b,d){for(var f=[],h=3;h<arguments.length;h++)f[h-3]=arguments[h];return a.apply(this,[c,webrpcclassinfo_1.class_id_t.RTCSessionDescription,b,d].concat(f))||this}__extends(b,a);b.prototype.toJSON=function(){return{type:this.type_,sdp:this.sdp_}};Object.defineProperty(b.prototype,"sdp",{get:function(){return this.sdp_},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"type",{get:function(){return this.type_},enumerable:!0,configurable:!0});
b.prototype.syncBarrier=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".syncBarrier() called.");return new Promise(function(b,d){a.waitUntilConnected("SessionDescription.syncBarrier").then(function(){return Promise.all([a.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCSessionDescription_t.type,0),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCSessionDescription_t.sdp,"")])}).then(function(d){a.type_=a.convertType(a.param0(d[0]));a.sdp_=a.param0(d[1]);b(a)})["catch"](function(){d()})})};
b.prototype.convertType=function(a){return 0==a?"offer":1==a?"pranswer":"answer"};b.convertC2H=function(a){return"offer"==a?0:"pranswer"==a?1:2};return b}(proxyobject_1.ProxyObject);exports.SessionDescription=SessionDescription;
var PeerConnectionEvent=function(){return function(a,b){this.type=a;this.target=b}}(),RtpReceiver=function(a){function b(c,b){var d=a.call(this,c,webrpcclassinfo_1.class_id_t.RTCRtpReceiver,b,!0)||this;logger_1.logger.log(d.user_friendly_id()+".constructor");return d}__extends(b,a);b.prototype.syncBarrier=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".syncBarrier() called.");return new Promise(function(b,d){a.waitUntilConnected("RtpReceiver.syncBarrier").then(function(){return Promise.all([a.remoteInvoke(!1,
webrpcclassinfo_1.method_id_RTCRtpReceiver_t.track,{oid:a.object_id()}),a.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCRtpReceiver_t.getContributingSources,[])])}).then(function(b){var e;b=b.map(function(b){return a.param0(b)});e=b[0];a.contribsources=b[1];return void 0==a.track_||a.track_.object_id()!=e.oid?(new remotemedia_1.RemoteMediaTrack(a,e.oid)).syncBarrier():Promise.resolve(a.track_)}).then(function(d){a.track_=d;b(a)})["catch"](function(){logger_1.logger.log(a.user_friendly_id()+".syncBarrier(): rejected.");
d()})})};Object.defineProperty(b.prototype,"track",{get:function(){logger_1.logger.log(this.user_friendly_id()+".get track() called.");return this.track_},enumerable:!0,configurable:!0});b.prototype.getCapabilities=function(a){logger_1.logger.log(this.user_friendly_id()+".getCapabilities() called.");return this.capabilities};b.prototype.getContributingSources=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".getContributingSources() called. "+JSON.stringify(this.contribsources));
this.waitUntilConnected("PeerConnection.getReceivers").then(function(){return Promise.all([a.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCRtpReceiver_t.getContributingSources,[])])}).then(function(b){a.contribsources=b.map(function(b){return a.param0(b)})[0]})["catch"](function(){logger_1.logger.log(a.user_friendly_id()+".getContributingSources() didnt get response.");a.contribsources=[]});return this.contribsources};b.prototype.getParameters=function(){logger_1.logger.log(this.user_friendly_id()+
".getParameters() called.");return null};b.prototype.getStats=function(){logger_1.logger.log(this.user_friendly_id()+".getStats() called.");return null};b.prototype.getSynchronizationSources=function(){logger_1.logger.log(this.user_friendly_id()+".getSynchronizationSources() called.");return this.syncsources};return b}(proxyobject_1.ProxyObject),PeerConnection=function(a){function b(c){var b=a.call(this,null,webrpcclassinfo_1.class_id_t.RTCPeerConnection,0,!1,ensure_config_defined(c),{})||this;logger_1.logger.log("peerconnection.constructor");
logger_1.logger.log(JSON.stringify(c));b.localStreams=[];b.remoteStreams=[];b.onaddstream_=null;b.signalingState_="stable";b.iceConnectionState_="new";b.iceGatheringState_="new";b.iceQ_=new IceGatherer(b);b.receivers_=[];return b}__extends(b,a);b.prototype.addIceCandidate=function(){logger_1.logger.log(this.user_friendly_id()+".addIceCandidate");logger_1.logger.log(arguments)};Object.defineProperty(b.prototype,"onicecandidate",{get:function(){return this.onicecandidate_},set:function(a){var b=this;
logger_1.logger.log(this.user_friendly_id()+".set_onicecandidate() called.");this.onicecandidate_=a;this.waitUntilConnected("PeerConnection.onicecandidate").then(function(){var d=b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_RTCPeerConnection_t.onicecandidate);d.then(function(a){logger_1.logger.log(b.user_friendly_id()+".onicecandidate callback received!!!");a=new IceCandidateEvent(b,b.param0(a).oid,b);null!=b.iceQ_&&b.iceQ_.addIceCandidate(a)});return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_RTCPeerConnection_t.onicecandidate,
d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".set_onicecandidate() failed.")})},enumerable:!0,configurable:!0});b.prototype.convertIceConnectionState=function(a){return 0==a?"new":1==a?"checking":2==a?"connected":3==a?"completed":4==a?"failed":5==a?"disconnected":"closed"};Object.defineProperty(b.prototype,"oniceconnectionstatechange",{get:function(){return this.oniceconnectionstatechange_},set:function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".set_oniceconnectionstatechange() called.");
this.oniceconnectionstatechange_=a;this.waitUntilConnected("PeerConnection.oniceconnectionstatechange").then(function(){var d=b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_RTCPeerConnection_t.oniceconnectionstatechange);d.then(function(a){logger_1.logger.log(b.user_friendly_id()+".oniceconnectionstatechange(): success callback received!!!");b.iceConnectionState_=b.convertIceConnectionState(b.param0(a));a=new PeerConnectionEvent("iceconnectionstatechange",b);b.oniceconnectionstatechange_(a)});
return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_RTCPeerConnection_t.oniceconnectionstatechange,d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".set_oniceconnectionstatechange() failed.")})},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"iceConnectionState",{get:function(){logger_1.logger.log(this.user_friendly_id()+".get_iceConnectionState() called, value = "+this.iceConnectionState_);return this.iceConnectionState_},enumerable:!0,configurable:!0});
b.prototype.convertIceGatheringState=function(a){return 0==a?"new":1==a?"gathering":"complete"};Object.defineProperty(b.prototype,"onicegatheringstatechange",{get:function(){return this.onicegatheringstatechange_},set:function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".set_onicegatheringstatechange() called.");this.onicegatheringstatechange_=a;this.waitUntilConnected("PeerConnection.onicegatheringstatechange").then(function(){var d=b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_RTCPeerConnection_t.onicegatheringstatechange);
d.then(function(a){logger_1.logger.log(b.user_friendly_id()+".onicegatheringstatechange(): callback received!!!");b.iceGatheringState_=b.convertIceGatheringState(b.param0(a));null!=b.iceQ_&&b.iceQ_.pushState(b.iceGatheringState_)});return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_RTCPeerConnection_t.onicegatheringstatechange,d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".set_onicegatheringstatechange() failed.")})},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,
"iceGatheringState",{get:function(){logger_1.logger.log(this.user_friendly_id()+".get_iceGatheringState() called, value = "+this.iceGatheringState_);return this.iceGatheringState_},enumerable:!0,configurable:!0});b.prototype.convertSignalState=function(a){return 0==a?"stable":1==a?"have-local-offer":2==a?"have-local-pranswer":3==a?"have-remote-offer":4==a?"have-remote-pranswer":"closed"};Object.defineProperty(b.prototype,"onsignalingstatechange",{set:function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+
".set_onsignalingstatechange() called.");this.onsignalingstatechange_=a;this.waitUntilConnected("PeerConnection.onsignalingstatechanged").then(function(){var d=b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_RTCPeerConnection_t.onsignalingstatechange);d.then(function(a){logger_1.logger.log(b.user_friendly_id()+".onsignalingstatechange(): callback received!!!");b.signalingState_=b.convertSignalState(b.param0(a));a=new PeerConnectionEvent("onsignalingstatechange",b);b.onsignalingstatechange_(a)});
return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_RTCPeerConnection_t.onsignalingstatechange,d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".set_onsignalingstatechange(): failed.")})},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"onsignalingstatechanged",{get:function(){return this.onsignalingstatechange_},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"signalingState",{get:function(){logger_1.logger.log(this.user_friendly_id()+
".get_signalingState() called, value = "+this.signalingState_);return this.signalingState_},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"onnegotiationneeded",{get:function(){return this.onnegotiationneeded_},set:function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".set_onnegotiationneeded() called.");this.onnegotiationneeded_=a;this.waitUntilConnected("PeerConnection.onnegotiationneeded").then(function(){var d=b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_RTCPeerConnection_t.onnegotiationneeded);
d.then(function(){logger_1.logger.log(b.user_friendly_id()+".onnegotiationneeded(): callback received!!!");var a=new PeerConnectionEvent("negotiationneeded",b);b.onnegotiationneeded_(a)});return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_RTCPeerConnection_t.onnegotiationneeded,d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".set_onnegotiationneeded(): failed.")})},enumerable:!0,configurable:!0});b.prototype.createOffer=function(a,b,d){var f=this;logger_1.logger.log(this.user_friendly_id()+
".createOffer() called.",JSON.stringify(d));this.waitUntilConnected("PeerConnection.createOffer").then(function(){var a=f.registerCallbacks(!0,!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.createOffer);f.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.createOffer,a.success,a.fail,{});return a.prom()}).then(function(a){logger_1.logger.log(f.user_friendly_id()+".createOffer(): success callback received!!!");return(new SessionDescription(f,f.param0(a).oid,!0)).syncBarrier()}).then(function(b){a&&
a(b)})["catch"](function(){logger_1.logger.log(f.user_friendly_id()+".createOffer() failed.");b&&b(new DOMException("PeerConnection.createOffer() failed.","PeerConnection"))})};b.prototype.createAnswer=function(a,b,d){var f=this;logger_1.logger.log(this.user_friendly_id()+".createAnswer() called.",JSON.stringify(d));this.waitUntilConnected("PeerConnection.createAnswer").then(function(){var a=f.registerCallbacks(!0,!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.createAnswer);f.remoteInvoke(!1,
webrpcclassinfo_1.method_id_RTCPeerConnection_t.createAnswer,a.success,a.fail,{},{});return a.prom()}).then(function(a){logger_1.logger.log(f.user_friendly_id()+".createAnswer(): success callback received!!!");return(new SessionDescription(f,f.param0(a).oid,!0)).syncBarrier()}).then(function(b){a&&a(b)})["catch"](function(){logger_1.logger.log(f.user_friendly_id()+".createAnswer() failed.");b&&b("PeerConnection::createAnswer() failed.")})};b.prototype.updateLocalDescription=function(){return __awaiter(this,
void 0,void 0,function(){var a,b,d;return __generator(this,function(f){switch(f.label){case 0:return logger_1.logger.log(this.user_friendly_id()+".updateLocalDescription() called."),[4,this.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.localDescription,{oid:this.object_id()})];case 1:return a=f.sent(),b=new SessionDescription(this,this.param0(a).oid,!0),[4,b.syncBarrier()];case 2:return this.localDescription=d=f.sent(),[2]}})})};b.prototype.setLocalDescription=function(a,b,d){var f=
this;logger_1.logger.log(this.user_friendly_id()+".setLocalDescription() called.");this.waitUntilConnected("PeerConnection.setLocalDescription").then(function(){return(new SessionDescription(f,0,!1,{type:SessionDescription.convertC2H(a.type),sdp:a.sdp})).syncBarrier()}).then(function(a){var c=f.registerCallbacks(!0,!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.setLocalDescription);f.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.setLocalDescription,{oid:a.object_id()},c.success,
c.fail);c.prom().then(function(){logger_1.logger.log(f.user_friendly_id()+".setLocalDescription(): success callback received!!!");f.localDescription=a;b&&b()})})["catch"](function(){logger_1.logger.log(f.user_friendly_id()+".setLocalDescription() failed.");d&&d("PeerConnection::setLocalDescription() failed.")})};b.prototype.setRemoteDescription=function(a,b,d){var f=this;logger_1.logger.log(this.user_friendly_id()+".setRemoteDescription() called.");this.waitUntilConnected("PeerConnection.setRemoteDescription").then(function(){return(new SessionDescription(f,
0,!1,{type:SessionDescription.convertC2H(a.type),sdp:a.sdp})).syncBarrier()}).then(function(a){var c=f.registerCallbacks(!0,!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.setRemoteDescription);f.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.setRemoteDescription,{oid:a.object_id()},c.success,c.fail);c.prom().then(function(){logger_1.logger.log(f.user_friendly_id()+".setRemoteDescription(): success callback received!!!");f.remoteDescription=a;b&&b()})})["catch"](function(){logger_1.logger.log(f.user_friendly_id()+
".setRemoteDescription() failed.");d&&d("PeerConnection::setRemoteDescription() failed.")})};b.prototype.getLocalStreams=function(){logger_1.logger.log("PeerConnection.getLocalStreams() called. [oid="+this.object_id()+"]");for(var a=0,b=this.localStreams;a<b.length;a++)logger_1.logger.log(JSON.stringify(b[a]));return this.localStreams};b.prototype.getRemoteStreams=function(){logger_1.logger.log(this.user_friendly_id()+".getRemoteStreams() called.");for(var a=0,b=this.remoteStreams;a<b.length;a++)logger_1.logger.log(JSON.stringify(b[a]));
return this.remoteStreams};b.prototype.addStream=function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".addStream() called: "+JSON.stringify(a));a.dumpTrackInfo();this.localStreams.push(a);this.waitUntilConnected("PeerConnection.addStream").then(function(){return b.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.addStream,{oid:a.object_id()},{})}).then(function(){logger_1.logger.log(b.user_friendly_id()+".addStream() success.")})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+
".addStream() failed.")})};b.prototype.removeStream=function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".removeStream() called: "+JSON.stringify(a));for(var d=0;d<this.localStreams.length;d++)this.localStreams[d]==a&&this.localStreams.splice(d,1);this.waitUntilConnected("PeerConnection.removeStream").then(function(){return b.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.removeStream,{oid:a.object_id()})}).then(function(){logger_1.logger.log(b.user_friendly_id()+".removeStream() success.")})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+
".removeStream() failed.")})};Object.defineProperty(b.prototype,"onaddstream",{get:function(){return this.onaddstream_},set:function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".set_onaddstream() called.");this.onaddstream_=a;this.waitUntilConnected("PeerConnection.onaddstream").then(function(){var d=b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_RTCPeerConnection_t.onaddstream);d.then(function(a){(new remotemedia_1.RemoteStreamEvent(b,b.param0(a).oid)).syncBarrier().then(function(a){for(var c=
0,d=a.stream.getAudioTracks();c<d.length;c++)d[c].enabled=!1;logger_1.logger.log(b.user_friendly_id()+".onaddstream callback received!");b.remoteStreams.push(a.stream);b.onaddstream_(a)})});return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_RTCPeerConnection_t.onaddstream,d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".set_onaddstream(): failed!")})},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"onremovestream",{get:function(){return this.onremovestream_},
set:function(a){var b=this;logger_1.logger.log(this.user_friendly_id()+".set_onremovestream() called.");this.onremovestream_=a;this.waitUntilConnected("PeerConnection.onremovestream").then(function(){var d=b.registerCallbacks(!1,b.isNullCallback(a),webrpcclassinfo_1.method_id_RTCPeerConnection_t.onremovestream);d.then(function(a){(new remotemedia_1.RemoteStreamEvent(b,b.param0(a).oid)).syncBarrier().then(function(a){logger_1.logger.log(b.user_friendly_id()+".onremovestream callback received!");var c=
b.remoteStreams.findIndex(function(b){return b.id==a.stream.id});0<=c&&b.remoteStreams.splice(c,1);b.onremovestream_(a)})});return b.remoteInvoke(!0,webrpcclassinfo_1.method_id_RTCPeerConnection_t.onremovestream,d.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".set_onremovestream(): failed!")})},enumerable:!0,configurable:!0});b.prototype.getStats=function(a){logger_1.logger.log(this.user_friendly_id()+".getStats");var b=this;return new Promise(function(d,f){b.isRedirected()?
b.waitUntilConnected("PeerConnection.getStats").then(function(){var f=b.registerCallbacks(!0,!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.getStats);f.then(function(b){void 0!==b.params&&0!==b.params.length&&(a(stats_1.StatsReport.fromJSON(JSON.parse(b.params[0]))),d())});return b.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.getStats,f.success)})["catch"](function(){logger_1.logger.log(b.user_friendly_id()+".getStats(): failed!");f()}):(logger_1.logger.log(b.user_friendly_id()+
".getStats(): not in active redirection!"),a({}),d())})};b.prototype.close=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".close() called.");this.onnegotiationneeded=this.onsignalingstatechange=this.onicegatheringstatechange=this.oniceconnectionstatechange=this.onicecandidate=this.onaddstream=null;this.waitUntilConnected("PeerConnection.close").then(function(){return a.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.close)}).then(function(){a.iceQ_=null;a.release();
logger_1.logger.log(a.user_friendly_id()+".close() success.")})["catch"](function(){a.iceQ_=null;a.release();logger_1.logger.log(a.user_friendly_id()+".close() failed.")})};b.prototype.getSenders=function(){logger_1.logger.log(this.user_friendly_id()+".getSenders() called.")};b.prototype.getReceivers=function(){var a=this;logger_1.logger.log(this.user_friendly_id()+".getReceivers() called.");this.waitUntilConnected("PeerConnection.getReceivers").then(function(){return a.remoteInvoke(!1,webrpcclassinfo_1.method_id_RTCPeerConnection_t.getReceivers,
[])}).then(function(b){var d=[];b.params[0].forEach(function(b){var e=a.receivers_.find(function(a){return a.object_id()===b.oid});void 0===e?(e=new RtpReceiver(a,b.oid),d.push(e.syncBarrier())):d.push(e)});return Promise.all(d)}).then(function(b){logger_1.logger.log(a.user_friendly_id()+".getReceivers: returning receiver with ids ["+b.map(function(a){return a.object_id()})+"]");a.receivers_=b})["catch"](function(){logger_1.logger.log(a.user_friendly_id()+".getReceivers() didnt get response.");a.receivers_=
[]});return this.receivers_};return b}(proxyobject_1.ProxyObject);exports.PeerConnection=PeerConnection;
